    ...
    <div class="container">
        <div class="about-page">
            <div class="left-column">
                <img src="./images/staff12.jpg" alt="Main Image" class="main-image">
             
            </div>
            <div class="about-list">
               
           <h5>The Largest and the most preferred café  in Sri Lanka, brewing the finest coffee island wide</h5>
           <h3>Connect with us</h3>
              
            <h5>Gallery Coffee Lanka Pvt Ltd,<br>
                No 225/1, Nawela Road,<br>
                Colombo 05<br>
                info@gallery.lk</h5>
