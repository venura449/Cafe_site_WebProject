...
<form id="form1" style="width: 100%" action="Handlers/AddeventHand.php" method="post" enctype="multipart/form-data">
    ...
    <br>
    <label for="card">Event Image</label>
    <input type="file" id="image" name="image" placeholder="JPG/PNG"/>
    <br>
    <div class="exp-cvc">
        <div class="expiration">
            <label for="expiry">Event Start : </label>
            <input class="inputCard" name="start" id="expiry" type="date" placeholder="DD/MM/YYYY"/>
            <br>
        </div>
        <div class="security">
            <label for="cvc">Event End</label>
            <input type="date"  id="cvc" name="end" placeholder="DD/MM/YYYY" />
            <br>
        </div>
    </div>
